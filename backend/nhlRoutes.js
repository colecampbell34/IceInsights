...
// const fetchHeadToHead = async (teamAbbr1, teamAbbr2, season = 20242025) => {
//   try {
...
//       (game) =>
//         (game.homeTeam.abbrev === teamAbbr1 &&
//           game.awayTeam.abbrev === teamAbbr2) ||
//         (game.homeTeam.abbrev === teamAbbr2 &&
//           game.awayTeam.abbrev === teamAbbr1)
//     );

//     // If no games were found for this matchup, return an equal result
//     if (games.length === 0) {
//       return {
//         team1Wins: 0,
//         team2Wins: 0,
...
//     // Add the filtered games to the matchups
...
//     const team1Wins = matchups.reduce((acc, game) => acc + game.team1Wins, 0);
//     const team2Wins = matchups.reduce((acc, game) => acc + game.team2Wins, 0);
...
//   } catch (error) {
//     console.error(
//       `Error fetching head-to-head for ${teamAbbr1} vs ${teamAbbr2}:`,
//       error.message
//     );
...
//   const normalize = (value, max) => (value !== null ? value / max : 0);

//   const last10WinPct1 = normalize(last10Team1?.wins || 0, 10);
//   const last10WinPct2 = normalize(last10Team2?.wins || 0, 10);

//   const seasonWinPct1 = team1Stats.wins / (team1Stats.wins + team1Stats.losses);
//   const seasonWinPct2 = team2Stats.wins / (team2Stats.wins + team2Stats.losses);

//   const homeAwayAdvantage1 = normalize(
//     team1Stats.homeWins,
//     team1Stats.homeWins + team1Stats.homeLosses
//   );
//   const homeAwayAdvantage2 = normalize(
//     team2Stats.roadWins,
//     team2Stats.roadWins + team2Stats.roadLosses
//   );

//   const headToHeadPct1 = normalize(
//     headToHead?.team1Wins || 0,
//     headToHead?.totalGames || 5
//   );
//   const headToHeadPct2 = normalize(
...
//     last10WinPct2 * 0.3 +
//     seasonWinPct2 * 0.25 +
//     homeAwayAdvantage2 * 0.15 +
//     headToHeadPct2 * 0.15 +
//     goalDiff2 * 0.15;

//   const predictedWinner =
//     score1 > score2 ? team1Stats.teamName.default : team2Stats.teamName.default;

//   return {
//     predictedWinner,
//     predictedScore: `${Math.floor(Math.random() * 3) + 2}-${
